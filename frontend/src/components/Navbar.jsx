        ...
        <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-white/90 backdrop-blur-md shadow-md py-3' : 'bg-transparent py-5'}`}>
            <div className="container mx-auto px-6 flex justify-between items-center">
                ...
                <div className="flex items-center gap-4">
                    <Link to="/login" className="text-ayur-deep font-semibold hover:text-ayur-light transition-smooth">
                        Login
                    </Link>
                    <Link to="/login" className="bg-ayur-deep text-white px-6 py-2 rounded-full font-semibold hover:bg-ayur-light hover:shadow-lg transition-smooth border-2 border-transparent hover:border-ayur-deep">
                        Get Started
                    </Link>
                </div>
            </div>
